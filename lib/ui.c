...
void ui_init() {
    ...
    SDL_SetWindowPosition(sdlDebugWindow, x + SCREEN_WIDTH + 10, y); //initialises a debug window in the same level as the main window
}
...
void updateDebugWindow() {
    ...
    rc.w = debugScreen->w;
    rc.h = debugScreen->h;
    SDL_FillRect(debugScreen, &rc, 0xFF111111); //fills the entire debug screen with a dark grey color
